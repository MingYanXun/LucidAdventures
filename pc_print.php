...
while($listcount <= 1)
{
	...
	<select class='engine' name = 'pc_to_print'>
	<option value = '1'>Choose Character</option>
	";
	
	$get_characters = mysql_query("SELECT * FROM ".$slrp_prefix."creature WHERE creature_id > '1' AND creature_status_id = '4' OR creature_status_id = '8' ORDER BY creature");
	...
	<br>
	<br>
	Long form <input type='checkbox' value='1' name='verbose'>
	<hr>
	<br>
	<br>
	<br>
...
<hr width = '100%'>
<input type='submit' class='submit3' value='Print Characters' name='pc_print_page'>
</form>
</td>
